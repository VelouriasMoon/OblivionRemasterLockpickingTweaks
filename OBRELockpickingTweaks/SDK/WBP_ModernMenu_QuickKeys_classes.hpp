...
public:
	...
	uint8                                         Pad_3E91[0x3];                                     // 0x054D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3E92[0x4];                                     // 0x0574(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnCloseAnimationEnd;                               // 0x0578(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void OnCloseAnimationEnd__DelegateSignature();
	...
	void SetQuickKeyByIndex(int32 Param_Index, class UTexture2D* Texture);
	void SetVisibilityByIndex(int32 Param_Index, bool bVisibility);
