...
public:
	...
	uint8                                         Pad_4C3D[0x3];                                     // 0x0425(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4C3E[0x3];                                     // 0x0435(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4C3F[0x3];                                     // 0x0441(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4C40[0x3];                                     // 0x0449(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void One_Rotation(class USceneComponent* Mesh, const struct FRotator& Original_Rotation, const struct FRotator& Target_Rotation, double Param_Timeline);
	void One_Teleport(class USceneComponent* Mesh, const struct FVector& Target_Location, const struct FRotator& Target_Rotation);
	void One_Translation(class USceneComponent* Mesh, const struct FVector& Original_Location, const struct FVector& Target_Location, double Param_Timeline);
