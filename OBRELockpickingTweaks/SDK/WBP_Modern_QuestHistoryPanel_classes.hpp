...
public:
	...
	FMulticastInlineDelegateProperty_             OnHistoryBackAction;                               // 0x0568(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             OnRequestGoToMap;                                  // 0x0578(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	FMulticastInlineDelegateProperty_             OnCarouselItemChanged;                             // 0x0628(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void OnCarouselItemChanged__DelegateSignature(int32 ItemIndex);
	void OnCarouselUpdate(int32 Current_Page_Index);
	void OnFocus();
	void OnHistoryBackAction__DelegateSignature();
	void OnRequestGoToMap__DelegateSignature();
	...
	void ShouldDisplayLastStep(bool* Param_ShouldDisplayLastStep);
