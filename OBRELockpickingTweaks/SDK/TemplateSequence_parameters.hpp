...
public:
	...
	uint8                                         Pad_333C[0x7];                                     // 0x0009(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_333E[0x8];                                     // 0x0008(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMinimalViewInfo                       ReturnValue;                                       // 0x0010(0x07D0)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(SequenceCameraShakeTestUtil_GetCameraCachePOV) == 0x0007E0, "Wrong size on SequenceCameraShakeTestUtil_GetCameraCachePOV");
...
public:
	class APlayerController*                      PlayerController;                                  // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_333F[0x8];                                     // 0x0008(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMinimalViewInfo                       ReturnValue;                                       // 0x0010(0x07D0)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(SequenceCameraShakeTestUtil_GetLastFrameCameraCachePOV) == 0x0007E0, "Wrong size on SequenceCameraShakeTestUtil_GetLastFrameCameraCachePOV");
...
public:
	...
	uint8                                         Pad_3341[0xB];                                     // 0x0705(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
