...
static_assert(offsetof(TABP_MeleeAttack_LightCombo_C_AnimGraph, Param_AnimGraph) == 0x000000, "Member 'TABP_MeleeAttack_LightCombo_C_AnimGraph::Param_AnimGraph' has a wrong offset!");
...
static_assert(offsetof(TABP_MeleeAttack_LightCombo_C_AttackingLayer, Param_AttackingLayer) == 0x000010, "Member 'TABP_MeleeAttack_LightCombo_C_AttackingLayer::Param_AttackingLayer' has a wrong offset!");
