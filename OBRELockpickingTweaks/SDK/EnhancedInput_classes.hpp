...
public:
	...
	uint8                                         Pad_1E72[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1E77[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E78[0x20];                                    // 0x0050(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1E7F[0x38];                                    // 0x0128(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E80[0x7];                                     // 0x00E1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E86[0x7];                                     // 0x0061(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1E93[0x1A0];                                   // 0x0030(0x01A0)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1E94[0x1A0];                                   // 0x0030(0x01A0)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E95[0x10];                                    // 0x01D8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
// 0x0358 (0x0800 - 0x04A8)
class UEnhancedPlayerInput final : public UPlayerInput
{
public:
	TMap<class UInputAction*, struct FKeyConsumptionOptions> KeyConsumptionData;                                // 0x04A8(0x0050)(Protected, NativeAccessSpecifierProtected)
	TMap<class UInputMappingContext*, int32>      AppliedInputContexts;                              // 0x04F8(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TArray<struct FEnhancedActionKeyMapping>      EnhancedActionMappings;                            // 0x0548(0x0010)(ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1E97[0x50];                                    // 0x0558(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class UInputAction*, struct FInputActionInstance> ActionInstanceData;                                // 0x05A8(0x0050)(Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1E98[0xA0];                                    // 0x05F8(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FKey, struct FVector>             KeysPressedThisTick;                               // 0x0698(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<class UInputAction*, struct FInjectedInputArray> InputsInjectedThisTick;                            // 0x06E8(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TSet<class UInputAction*>                     LastInjectedActions;                               // 0x0738(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1E99[0x78];                                    // 0x0788(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEnhancedPlayerInput) == 0x000800, "Wrong size on UEnhancedPlayerInput");
static_assert(offsetof(UEnhancedPlayerInput, KeyConsumptionData) == 0x0004A8, "Member 'UEnhancedPlayerInput::KeyConsumptionData' has a wrong offset!");
static_assert(offsetof(UEnhancedPlayerInput, AppliedInputContexts) == 0x0004F8, "Member 'UEnhancedPlayerInput::AppliedInputContexts' has a wrong offset!");
static_assert(offsetof(UEnhancedPlayerInput, EnhancedActionMappings) == 0x000548, "Member 'UEnhancedPlayerInput::EnhancedActionMappings' has a wrong offset!");
static_assert(offsetof(UEnhancedPlayerInput, ActionInstanceData) == 0x0005A8, "Member 'UEnhancedPlayerInput::ActionInstanceData' has a wrong offset!");
static_assert(offsetof(UEnhancedPlayerInput, KeysPressedThisTick) == 0x000698, "Member 'UEnhancedPlayerInput::KeysPressedThisTick' has a wrong offset!");
static_assert(offsetof(UEnhancedPlayerInput, InputsInjectedThisTick) == 0x0006E8, "Member 'UEnhancedPlayerInput::InputsInjectedThisTick' has a wrong offset!");
static_assert(offsetof(UEnhancedPlayerInput, LastInjectedActions) == 0x000738, "Member 'UEnhancedPlayerInput::LastInjectedActions' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1E9A[0x6];                                     // 0x0052(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void UnmapAllKeysFromActionKeepOrder(const class UInputAction* Action);
...
public:
	...
	uint8                                         Pad_1E9C[0x7];                                     // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E9D[0x5];                                     // 0x002B(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1E9E[0x30];                                    // 0x0028(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E9F[0x3];                                     // 0x002D(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1EA0[0x7];                                     // 0x0029(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1EA1[0x3];                                     // 0x002D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1EA4[0x3];                                     // 0x0055(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1EA5[0x4];                                     // 0x0058(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1EA6[0x7];                                     // 0x0061(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1EA7[0x4];                                     // 0x005C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1EA8[0x4];                                     // 0x005C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1EA9[0x4];                                     // 0x0058(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1EAA[0x3];                                     // 0x005D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1EAB[0x7];                                     // 0x0051(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
