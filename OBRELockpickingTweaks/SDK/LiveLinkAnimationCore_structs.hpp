...
public:
	...
	uint8                                         Pad_2CB0[0x10];                                    // 0x0038(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FLiveLinkInstanceProxy) == 0x000740, "Wrong size on FLiveLinkInstanceProxy");
static_assert(offsetof(FLiveLinkInstanceProxy, PoseNode) == 0x0006F8, "Member 'FLiveLinkInstanceProxy::PoseNode' has a wrong offset!");
