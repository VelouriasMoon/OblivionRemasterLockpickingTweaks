...
static_assert(offsetof(ALI_BodyPhysics_C_BodyPhysics, Param_BodyPhysics) == 0x000010, "Member 'ALI_BodyPhysics_C_BodyPhysics::Param_BodyPhysics' has a wrong offset!");
