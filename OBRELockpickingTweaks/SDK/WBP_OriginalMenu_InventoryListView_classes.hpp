...
public:
	...
	uint8                                         Pad_47A0[0x7];                                     // 0x0561(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	FMulticastInlineDelegateProperty_             OnListViewUpdated;                                 // 0x0570(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             OnScrollBarVisibilityChanged;                      // 0x0580(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             OnMouseHoverListViewChanged;                       // 0x0590(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void OnListViewUpdated__DelegateSignature(bool IsEmpty);
	void OnMouseEnter(const struct FGeometry& MyGeometry, const struct FPointerEvent& MouseEvent);
	void OnMouseHoverListViewChanged__DelegateSignature(bool Param_IsHovered);
	void OnMouseLeave(const struct FPointerEvent& MouseEvent);
	void OnScrollBarVisibilityChanged__DelegateSignature(ESlateVisibility NewParam);
