...
public:
	...
	uint8                                         Pad_3391[0x3];                                     // 0x035D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3392[0x3];                                     // 0x036D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3393[0x5];                                     // 0x0383(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	FMulticastInlineDelegateProperty_             OnInventoryItemDisplayed;                          // 0x0390(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void GetViewportRect(struct FVector2D* Param_TopLeft, struct FVector2D* TopRight, struct FVector2D* BottomLeft, struct FVector2D* Param_BottomRight);
	...
	void OnInventoryItemDisplayed__DelegateSignature(bool IsItemDisplayed);
