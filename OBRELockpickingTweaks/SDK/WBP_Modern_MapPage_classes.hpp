...
public:
	...
	uint8                                         Pad_4417[0x7];                                     // 0x04E9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4418[0x7];                                     // 0x0501(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4419[0x7];                                     // 0x0541(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             RequestMapChangeDispatcher;                        // 0x0548(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             IconHoverVisibility;                               // 0x0558(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	FMulticastInlineDelegateProperty_             SleepWaitMenuRequested;                            // 0x0598(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	uint8                                         Pad_441A[0x7];                                     // 0x05C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void IconHoverVisibility__DelegateSignature(int32 KeyID, bool NewVisibility);
	...
	void RequestMapChangeDispatcher__DelegateSignature(const struct FVector2D& VirtualCurorPosition);
	...
	void SleepWaitMenuRequested__DelegateSignature();
