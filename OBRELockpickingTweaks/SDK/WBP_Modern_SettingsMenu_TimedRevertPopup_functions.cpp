...
void UWBP_Modern_SettingsMenu_TimedRevertPopup_C::OnPopupQuit__DelegateSignature(int32 ButtonIndex)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Modern_SettingsMenu_TimedRevertPopup_C", "OnPopupQuit__DelegateSignature");

	Params::WBP_Modern_SettingsMenu_TimedRevertPopup_C_OnPopupQuit__DelegateSignature Parms{};
