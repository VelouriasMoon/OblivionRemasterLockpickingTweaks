...
static_assert(offsetof(WBP_Modern_MapIcon_C_GetName, Param_Name) == 0x000000, "Member 'WBP_Modern_MapIcon_C_GetName::Param_Name' has a wrong offset!");
...
{
public:
	bool                                          Param_IsInRightInputMethod;                        // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4778[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(WBP_Modern_MapIcon_C_IsInRightInputMethod, Param_IsInRightInputMethod) == 0x000000, "Member 'WBP_Modern_MapIcon_C_IsInRightInputMethod::Param_IsInRightInputMethod' has a wrong offset!");
...
struct WBP_Modern_MapIcon_C_OnIconClicked__DelegateSignature final
{
public:
	class FString                                 Address;                                           // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_Modern_MapIcon_C_OnIconClicked__DelegateSignature) == 0x000008, "Wrong alignment on WBP_Modern_MapIcon_C_OnIconClicked__DelegateSignature");
static_assert(sizeof(WBP_Modern_MapIcon_C_OnIconClicked__DelegateSignature) == 0x000010, "Wrong size on WBP_Modern_MapIcon_C_OnIconClicked__DelegateSignature");
static_assert(offsetof(WBP_Modern_MapIcon_C_OnIconClicked__DelegateSignature, Address) == 0x000000, "Member 'WBP_Modern_MapIcon_C_OnIconClicked__DelegateSignature::Address' has a wrong offset!");

// Function WBP_Modern_MapIcon.WBP_Modern_MapIcon_C.OnIconHovered__DelegateSignature
// 0x0008 (0x0008 - 0x0000)
struct WBP_Modern_MapIcon_C_OnIconHovered__DelegateSignature final
{
public:
	class UWBP_Modern_MapIcon_C*                  Param_Icon;                                        // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_Modern_MapIcon_C_OnIconHovered__DelegateSignature) == 0x000008, "Wrong alignment on WBP_Modern_MapIcon_C_OnIconHovered__DelegateSignature");
static_assert(sizeof(WBP_Modern_MapIcon_C_OnIconHovered__DelegateSignature) == 0x000008, "Wrong size on WBP_Modern_MapIcon_C_OnIconHovered__DelegateSignature");
static_assert(offsetof(WBP_Modern_MapIcon_C_OnIconHovered__DelegateSignature, Param_Icon) == 0x000000, "Member 'WBP_Modern_MapIcon_C_OnIconHovered__DelegateSignature::Param_Icon' has a wrong offset!");

// Function WBP_Modern_MapIcon.WBP_Modern_MapIcon_C.OnIconUnhovered__DelegateSignature
// 0x0008 (0x0008 - 0x0000)
struct WBP_Modern_MapIcon_C_OnIconUnhovered__DelegateSignature final
{
public:
	class UWBP_Modern_MapIcon_C*                  Param_Icon;                                        // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_Modern_MapIcon_C_OnIconUnhovered__DelegateSignature) == 0x000008, "Wrong alignment on WBP_Modern_MapIcon_C_OnIconUnhovered__DelegateSignature");
static_assert(sizeof(WBP_Modern_MapIcon_C_OnIconUnhovered__DelegateSignature) == 0x000008, "Wrong size on WBP_Modern_MapIcon_C_OnIconUnhovered__DelegateSignature");
static_assert(offsetof(WBP_Modern_MapIcon_C_OnIconUnhovered__DelegateSignature, Param_Icon) == 0x000000, "Member 'WBP_Modern_MapIcon_C_OnIconUnhovered__DelegateSignature::Param_Icon' has a wrong offset!");
...
static_assert(offsetof(WBP_Modern_MapIcon_C_SetProperties, Param_Properties) == 0x000000, "Member 'WBP_Modern_MapIcon_C_SetProperties::Param_Properties' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4779[0xF];                                     // 0x0DB1(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_477A[0xF];                                     // 0x1B71(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_477B[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_477C[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
