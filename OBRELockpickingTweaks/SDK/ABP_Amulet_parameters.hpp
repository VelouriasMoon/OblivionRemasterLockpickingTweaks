...
static_assert(offsetof(ABP_Amulet_C_AnimGraph, Param_AnimGraph) == 0x000000, "Member 'ABP_Amulet_C_AnimGraph::Param_AnimGraph' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4A0E[0x7];                                     // 0x0009(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
