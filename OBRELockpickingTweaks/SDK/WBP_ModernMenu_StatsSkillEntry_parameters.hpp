...
// Function WBP_ModernMenu_StatsSkillEntry.WBP_ModernMenu_StatsSkillEntry_C.OnFocusEvent__DelegateSignature
// 0x0008 (0x0008 - 0x0000)
struct WBP_ModernMenu_StatsSkillEntry_C_OnFocusEvent__DelegateSignature final
{
public:
	class UWBP_ModernMenu_StatsSkillEntry_C*      NewParam;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_ModernMenu_StatsSkillEntry_C_OnFocusEvent__DelegateSignature) == 0x000008, "Wrong alignment on WBP_ModernMenu_StatsSkillEntry_C_OnFocusEvent__DelegateSignature");
static_assert(sizeof(WBP_ModernMenu_StatsSkillEntry_C_OnFocusEvent__DelegateSignature) == 0x000008, "Wrong size on WBP_ModernMenu_StatsSkillEntry_C_OnFocusEvent__DelegateSignature");
static_assert(offsetof(WBP_ModernMenu_StatsSkillEntry_C_OnFocusEvent__DelegateSignature, NewParam) == 0x000000, "Member 'WBP_ModernMenu_StatsSkillEntry_C_OnFocusEvent__DelegateSignature::NewParam' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2614[0xC];                                     // 0x0014(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2615[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(WBP_ModernMenu_StatsSkillEntry_C_SetProperties, Param_Index) == 0x0000B0, "Member 'WBP_ModernMenu_StatsSkillEntry_C_SetProperties::Param_Index' has a wrong offset!");
