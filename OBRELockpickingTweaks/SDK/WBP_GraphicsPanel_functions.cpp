...
// Function WBP_GraphicsPanel.WBP_GraphicsPanel_C.NeedRefreshOptions__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UWBP_GraphicsPanel_C::NeedRefreshOptions__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_GraphicsPanel_C", "NeedRefreshOptions__DelegateSignature");
...
// struct FFloatInterval                   ExtremalValue                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
