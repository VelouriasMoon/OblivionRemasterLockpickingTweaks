...
namespace Offsets
{
	constexpr int32 GObjects          = 0x09145170;
	constexpr int32 AppendString      = 0x00F4B710;
	constexpr int32 GNames            = 0x0909EE80;
	constexpr int32 GWorld            = 0x092B3878;
	constexpr int32 ProcessEvent      = 0x010FE060;
