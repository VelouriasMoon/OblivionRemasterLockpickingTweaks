...
public:
	...
	uint8                                         Pad_1D7F[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1D80[0x8];                                     // 0x0010(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(FMovieGraphRenderDataIdentifier) == 0x000038, "Wrong size on FMovieGraphRenderDataIdentifier");
...
static_assert(offsetof(FMovieGraphRenderDataIdentifier, RendererName) == 0x000008, "Member 'FMovieGraphRenderDataIdentifier::RendererName' has a wrong offset!");
static_assert(offsetof(FMovieGraphRenderDataIdentifier, SubResourceName) == 0x000018, "Member 'FMovieGraphRenderDataIdentifier::SubResourceName' has a wrong offset!");
static_assert(offsetof(FMovieGraphRenderDataIdentifier, CameraName) == 0x000028, "Member 'FMovieGraphRenderDataIdentifier::CameraName' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1D81[0x1];                                     // 0x0017(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	class FName                                   RootBranch;                                        // 0x0000(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ShotIndex;                                         // 0x0008(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ShotCount;                                         // 0x000C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMoviePipelineExecutorJob*              Job;                                               // 0x0010(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FMovieGraphRenderDataIdentifier        RenderDataIdentifier;                              // 0x0020(0x0038)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMovieGraphTimeStepData                Time;                                              // 0x0058(0x0020)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMovieGraphTraversalContext) == 0x000008, "Wrong alignment on FMovieGraphTraversalContext");
static_assert(sizeof(FMovieGraphTraversalContext) == 0x000078, "Wrong size on FMovieGraphTraversalContext");
...
static_assert(offsetof(FMovieGraphTraversalContext, ShotIndex) == 0x000008, "Member 'FMovieGraphTraversalContext::ShotIndex' has a wrong offset!");
static_assert(offsetof(FMovieGraphTraversalContext, ShotCount) == 0x00000C, "Member 'FMovieGraphTraversalContext::ShotCount' has a wrong offset!");
static_assert(offsetof(FMovieGraphTraversalContext, Job) == 0x000010, "Member 'FMovieGraphTraversalContext::Job' has a wrong offset!");
...
static_assert(offsetof(FMovieGraphTraversalContext, Time) == 0x000058, "Member 'FMovieGraphTraversalContext::Time' has a wrong offset!");
...
{
public:
	struct FMovieGraphTraversalContext            UserContext;                                       // 0x0000(0x0078)(NativeAccessSpecifierPublic)
	TSet<class UMovieGraphNode*>                  VisitedNodes;                                      // 0x0078(0x0050)(UObjectWrapper, NativeAccessSpecifierPublic)
	class UMovieGraphPin*                         PinBeingFollowed;                                  // 0x00C8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UMovieGraphSubgraphNode*>        SubgraphStack;                                     // 0x00D0(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FMovieGraphEvaluationContext, VisitedNodes) == 0x000078, "Member 'FMovieGraphEvaluationContext::VisitedNodes' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1D82[0x7];                                     // 0x0019(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_1D83[0x2];                                     // 0x009E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D84[0x4];                                     // 0x00AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D85[0x4];                                     // 0x0124(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMovieGraphFilenameResolveParams) == 0x000008, "Wrong alignment on FMovieGraphFilenameResolveParams");
static_assert(sizeof(FMovieGraphFilenameResolveParams) == 0x000128, "Wrong size on FMovieGraphFilenameResolveParams");
...
static_assert(offsetof(FMovieGraphFilenameResolveParams, RootFrameNumber) == 0x000038, "Member 'FMovieGraphFilenameResolveParams::RootFrameNumber' has a wrong offset!");
static_assert(offsetof(FMovieGraphFilenameResolveParams, ShotFrameNumber) == 0x00003C, "Member 'FMovieGraphFilenameResolveParams::ShotFrameNumber' has a wrong offset!");
static_assert(offsetof(FMovieGraphFilenameResolveParams, RootFrameNumberRel) == 0x000040, "Member 'FMovieGraphFilenameResolveParams::RootFrameNumberRel' has a wrong offset!");
static_assert(offsetof(FMovieGraphFilenameResolveParams, ShotFrameNumberRel) == 0x000044, "Member 'FMovieGraphFilenameResolveParams::ShotFrameNumberRel' has a wrong offset!");
static_assert(offsetof(FMovieGraphFilenameResolveParams, FileMetadata) == 0x000048, "Member 'FMovieGraphFilenameResolveParams::FileMetadata' has a wrong offset!");
static_assert(offsetof(FMovieGraphFilenameResolveParams, Version) == 0x000098, "Member 'FMovieGraphFilenameResolveParams::Version' has a wrong offset!");
static_assert(offsetof(FMovieGraphFilenameResolveParams, bForceRelativeFrameNumbers) == 0x00009C, "Member 'FMovieGraphFilenameResolveParams::bForceRelativeFrameNumbers' has a wrong offset!");
static_assert(offsetof(FMovieGraphFilenameResolveParams, bEnsureAbsolutePath) == 0x00009D, "Member 'FMovieGraphFilenameResolveParams::bEnsureAbsolutePath' has a wrong offset!");
static_assert(offsetof(FMovieGraphFilenameResolveParams, InitializationTime) == 0x0000A0, "Member 'FMovieGraphFilenameResolveParams::InitializationTime' has a wrong offset!");
static_assert(offsetof(FMovieGraphFilenameResolveParams, ZeroPadFrameNumberCount) == 0x0000A8, "Member 'FMovieGraphFilenameResolveParams::ZeroPadFrameNumberCount' has a wrong offset!");
static_assert(offsetof(FMovieGraphFilenameResolveParams, FileNameFormatOverrides) == 0x0000B0, "Member 'FMovieGraphFilenameResolveParams::FileNameFormatOverrides' has a wrong offset!");
static_assert(offsetof(FMovieGraphFilenameResolveParams, Job) == 0x000100, "Member 'FMovieGraphFilenameResolveParams::Job' has a wrong offset!");
static_assert(offsetof(FMovieGraphFilenameResolveParams, Shot) == 0x000108, "Member 'FMovieGraphFilenameResolveParams::Shot' has a wrong offset!");
static_assert(offsetof(FMovieGraphFilenameResolveParams, EvaluatedConfig) == 0x000110, "Member 'FMovieGraphFilenameResolveParams::EvaluatedConfig' has a wrong offset!");
static_assert(offsetof(FMovieGraphFilenameResolveParams, FrameNumberOffset) == 0x000118, "Member 'FMovieGraphFilenameResolveParams::FrameNumberOffset' has a wrong offset!");
static_assert(offsetof(FMovieGraphFilenameResolveParams, DefaultFrameRate) == 0x00011C, "Member 'FMovieGraphFilenameResolveParams::DefaultFrameRate' has a wrong offset!");
...
public:
	...
	bool                                          bIsDynamicProperty;                                // 0x0008(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMovieGraphValueType                          ValueType;                                         // 0x0009(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D86[0x2];                                     // 0x000A(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FMovieGraphPropertyInfo) == 0x000004, "Wrong alignment on FMovieGraphPropertyInfo");
static_assert(sizeof(FMovieGraphPropertyInfo) == 0x00000C, "Wrong size on FMovieGraphPropertyInfo");
...
public:
	...
	bool                                          bAllowMultipleConnections;                         // 0x0009(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsBranch;                                         // 0x000A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D87[0x1];                                     // 0x000B(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FMovieGraphPinProperties, bAllowMultipleConnections) == 0x000009, "Member 'FMovieGraphPinProperties::bAllowMultipleConnections' has a wrong offset!");
static_assert(offsetof(FMovieGraphPinProperties, bIsBranch) == 0x00000A, "Member 'FMovieGraphPinProperties::bIsBranch' has a wrong offset!");
...
{
public:
	uint8                                         Pad_1D88[0xB0];                                    // 0x0000(0x00B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_1D89[0x3];                                     // 0x0035(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D8A[0x4];                                     // 0x00F4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D8B[0x8];                                     // 0x0100(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D8C[0x4];                                     // 0x0114(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
