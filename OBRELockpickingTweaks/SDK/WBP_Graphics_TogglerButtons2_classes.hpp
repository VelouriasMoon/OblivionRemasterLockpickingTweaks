...
public:
	...
	uint8                                         Pad_3ABE[0x3];                                     // 0x0559(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	FMulticastInlineDelegateProperty_             ToggleFSREvent;                                    // 0x0560(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void SetOptionText();
	void ToggleFSREvent__DelegateSignature();
	void UpdateValue();
