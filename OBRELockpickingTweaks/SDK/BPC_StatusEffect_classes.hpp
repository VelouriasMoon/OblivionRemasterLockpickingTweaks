...
public:
	...
	uint8                                         Pad_3C35[0x7];                                     // 0x00C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3C36[0x7];                                     // 0x00D9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3C37[0x7];                                     // 0x0101(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3C38[0x4];                                     // 0x012C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3C39[0x5];                                     // 0x015B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3C3A[0x7];                                     // 0x0181(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3C3B[0x7];                                     // 0x0199(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3C3C[0x7];                                     // 0x0201(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3C3D[0x4];                                     // 0x026C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3C3E[0x3];                                     // 0x027D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3C3F[0x7];                                     // 0x0289(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void OnStatusEffectStart(class UTESEffectShader* Param_Form, const TArray<struct FLinearColor>& VFXColors, const TArray<class UStaticMeshComponent*>& MeshIgnoreList, float StatusEffectValue);
	...
	void Pawn_OnTextureEffectStart(class UTESEffectShader* Param_Form, const TArray<struct FLinearColor>& VFXColors, const TArray<class UStaticMeshComponent*>& MeshIgnoreList, float StatusEffectValue);
	...
	void Update_Color_Values_Of_MID(TArray<EVBodyTextureEffectColors>& Color_Usages, TArray<struct FLinearColor>& Param_VFX_Colors, class UMaterialInstanceDynamic* Mid);
	void UpdateFPComponent(class AActor* FPComponent);
	void VStatusEffectTarget_OnTextureEffectStart(class UTESEffectShader* Param_Form, const TArray<struct FLinearColor>& VFXColors, const TArray<class UStaticMeshComponent*>& MeshIgnoreList, float StatusEffectValue);
