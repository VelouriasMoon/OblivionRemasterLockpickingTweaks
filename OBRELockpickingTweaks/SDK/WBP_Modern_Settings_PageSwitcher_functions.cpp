...
void UWBP_Modern_Settings_PageSwitcher_C::OnSettingItemHoverred__DelegateSignature(const struct FModernSettingTableRow& SettingData)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Modern_Settings_PageSwitcher_C", "OnSettingItemHoverred__DelegateSignature");

	Params::WBP_Modern_Settings_PageSwitcher_C_OnSettingItemHoverred__DelegateSignature Parms{};
