...
public:
	...
	uint8                                         Pad_4773[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	bool                                          Param_IsWorldMap;                                  // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4775[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(WBP_Modern_MapSmoothZoomSlider_C_SetHandlePositionWhenChangingMap, Param_IsWorldMap) == 0x000000, "Member 'WBP_Modern_MapSmoothZoomSlider_C_SetHandlePositionWhenChangingMap::Param_IsWorldMap' has a wrong offset!");
