...
void ULoadingScreenManager::OnLoadingScreenVisibilityChangedDelegate__DelegateSignature(bool InNewVisibility)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LoadingScreenManager", "OnLoadingScreenVisibilityChangedDelegate__DelegateSignature");

	Params::LoadingScreenManager_OnLoadingScreenVisibilityChangedDelegate__DelegateSignature Parms{};
...
class UUserWidget* ULoadingScreenManager::GetLoadingScreenWidget() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LoadingScreenManager", "GetLoadingScreenWidget");

	Params::LoadingScreenManager_GetLoadingScreenWidget Parms{};
