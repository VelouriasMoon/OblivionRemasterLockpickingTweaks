...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EVBloodColor                            Param_Blood_Color                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ABP_BloodImpact_C::Call_Fist_Blood_Event(EVBloodColor Param_Blood_Color, EVHitSourceType Hit_Source_Type)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Blood_Color = Param_Blood_Color;
...
void ABP_BloodImpact_C::Call_Weapon_Blood_Event(EVBloodColor Param_Blood_Color)
{
	static class UFunction* Func = nullptr;
...
// class UStaticMeshComponent*             WeaponComp                                             (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// struct FVector_NetQuantizeNormal        ImpactNormal                                           (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash)
...
// struct FVector                          Event_Hit_Direction                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
