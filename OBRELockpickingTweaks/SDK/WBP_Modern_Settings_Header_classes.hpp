...
public:
	...
	FMulticastInlineDelegateProperty_             IndexSelected;                                     // 0x04E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void Clear();
	void Construct();
	void CreateButton(const class FText& Label, int32 Param_Index, const struct FButtonStyle& DefaultStyle, const struct FButtonStyle& SelectedStyle);
	void Destruct();
	...
	void GetButtonAt(int32 Param_Index, class UWBP_Modern_Settings_HeaderButton_C** Button);
	void GetButtonIndex(class UWBP_Modern_Settings_HeaderButton_C* Button, int32* Param_Index);
	void IndexSelected__DelegateSignature(int32 Param_Index);
	...
	void TryDeleteButton(int32 Param_Index);
	void Unbinding();
