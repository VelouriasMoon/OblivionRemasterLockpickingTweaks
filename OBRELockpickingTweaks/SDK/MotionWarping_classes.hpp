...
public:
	...
	uint8                                         Pad_2212[0x7];                                     // 0x00A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2215[0xC];                                     // 0x0044(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2216[0x3];                                     // 0x00E5(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2217[0xF];                                     // 0x00F1(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2218[0x5];                                     // 0x016B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	EMotionWarpRotationMethod                     RotationMethod;                                    // 0x017A(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2219[0x1];                                     // 0x017B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	float                                         WarpMaxRotationRate;                               // 0x0180(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_221A[0xC];                                     // 0x0184(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_221B[0x70];                                    // 0x01F0(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(URootMotionModifier_Warp) == 0x000260, "Wrong size on URootMotionModifier_Warp");
...
static_assert(offsetof(URootMotionModifier_Warp, RotationMethod) == 0x00017A, "Member 'URootMotionModifier_Warp::RotationMethod' has a wrong offset!");
...
static_assert(offsetof(URootMotionModifier_Warp, WarpMaxRotationRate) == 0x000180, "Member 'URootMotionModifier_Warp::WarpMaxRotationRate' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_Warp, CachedTargetTransform) == 0x000190, "Member 'URootMotionModifier_Warp::CachedTargetTransform' has a wrong offset!");
...
static_assert(sizeof(URootMotionModifier_SimpleWarp) == 0x000260, "Wrong size on URootMotionModifier_SimpleWarp");
...
{
public:
	bool                                          bWarpIKBones;                                      // 0x0260(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_221C[0x7];                                     // 0x0261(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           IKBones;                                           // 0x0268(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_221D[0x8];                                     // 0x0278(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             CachedMeshTransform;                               // 0x0280(0x0060)(IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FTransform                             CachedMeshRelativeTransform;                       // 0x02E0(0x0060)(IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FTransform                             CachedRootMotion;                                  // 0x0340(0x0060)(IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FAnimSequenceTrackContainer            Result;                                            // 0x03A0(0x0020)(Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(URootMotionModifier_AdjustmentBlendWarp) == 0x0003C0, "Wrong size on URootMotionModifier_AdjustmentBlendWarp");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, bWarpIKBones) == 0x000260, "Member 'URootMotionModifier_AdjustmentBlendWarp::bWarpIKBones' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, IKBones) == 0x000268, "Member 'URootMotionModifier_AdjustmentBlendWarp::IKBones' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, CachedMeshTransform) == 0x000280, "Member 'URootMotionModifier_AdjustmentBlendWarp::CachedMeshTransform' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, CachedMeshRelativeTransform) == 0x0002E0, "Member 'URootMotionModifier_AdjustmentBlendWarp::CachedMeshRelativeTransform' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, CachedRootMotion) == 0x000340, "Member 'URootMotionModifier_AdjustmentBlendWarp::CachedRootMotion' has a wrong offset!");
static_assert(offsetof(URootMotionModifier_AdjustmentBlendWarp, Result) == 0x0003A0, "Member 'URootMotionModifier_AdjustmentBlendWarp::Result' has a wrong offset!");
...
static_assert(sizeof(URootMotionModifier_SkewWarp) == 0x000260, "Wrong size on URootMotionModifier_SkewWarp");
