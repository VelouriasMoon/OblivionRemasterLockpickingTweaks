...
// Parameters:
// class UTextureRenderTarget2D*           Param_RTA                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UTextureRenderTarget2D*           Param_RTB                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UJumpFlood_Component2D_C::Assign_RenderTargets(class UTextureRenderTarget2D* Param_RTA, class UTextureRenderTarget2D* Param_RTB)
{
	...
	Parms.Param_RTA = Param_RTA;
	Parms.Param_RTB = Param_RTB;
