...
static_assert(offsetof(TABP_GetUp_C_AnimGraph, Param_AnimGraph) == 0x000000, "Member 'TABP_GetUp_C_AnimGraph::Param_AnimGraph' has a wrong offset!");
...
static_assert(offsetof(TABP_GetUp_C_GetUpLayer, Param_GetUpLayer) == 0x000010, "Member 'TABP_GetUp_C_GetUpLayer::Param_GetUpLayer' has a wrong offset!");
