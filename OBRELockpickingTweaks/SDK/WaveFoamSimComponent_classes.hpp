...
public:
	...
	uint8                                         Pad_3EAD[0x4];                                     // 0x00DC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3EAE[0x7];                                     // 0x00F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3EAF[0x4];                                     // 0x0104(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void InitializeWaveFoamSim(int32 Param_Res, double WorldSize, double Fading, double TimeBias, class AWaterBody* WaterBody, class UShallowWaterSimComponent_C* Param_ShallowWater);
