...
// Parameters:
// class FText                             NewTitle                                               (BlueprintVisible, BlueprintReadOnly, Parm)
// class FText                             NewMessage                                             (BlueprintVisible, BlueprintReadOnly, Parm)
// class FText                             NewButton1Text                                         (BlueprintVisible, BlueprintReadOnly, Parm)
// class FText                             NewButton2Text                                         (BlueprintVisible, BlueprintReadOnly, Parm)
// class FText                             NewButton3Text                                         (BlueprintVisible, BlueprintReadOnly, Parm)
...
// bool                                    Param_ShouldQuitOnClose                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UWBP_Modern_SettingsMenu_ValidationPopup_C::OnPopupQuit__DelegateSignature(int32 ButtonIndex, bool Param_ShouldQuitOnClose, bool ShouldChangeSettingsPageOnClose, int32 SettingsPage)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_Modern_SettingsMenu_ValidationPopup_C", "OnPopupQuit__DelegateSignature");

	Params::WBP_Modern_SettingsMenu_ValidationPopup_C_OnPopupQuit__DelegateSignature Parms{};

	Parms.ButtonIndex = ButtonIndex;
	Parms.Param_ShouldQuitOnClose = Param_ShouldQuitOnClose;
