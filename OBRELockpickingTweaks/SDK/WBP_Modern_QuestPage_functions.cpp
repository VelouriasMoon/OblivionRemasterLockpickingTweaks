...
// Parameters:
// struct FLegacyMapMenuQuestProperties    NewProperty                                            (BlueprintVisible, BlueprintReadOnly, Parm)
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UWBP_Modern_Menu_Player_Footer_C* Param_Footer                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

void UWBP_Modern_QuestPage_C::InitFooter(class UWBP_Modern_Menu_Player_Footer_C* Param_Footer)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Footer = Param_Footer;
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// bool                                    Param_IsOnQuestListPage                                (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_Modern_QuestPage_C::IsOnQuestListPage(bool* Param_IsOnQuestListPage)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_IsOnQuestListPage != nullptr)
		*Param_IsOnQuestListPage = Parms.Param_IsOnQuestListPage;
}
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FLegacyMapMenuQuestProperties    QuestProperties                                        (BlueprintVisible, BlueprintReadOnly, Parm)
...
// Parameters:
// TArray<struct FLegacyMapMenuQuestProperties>NewQuestsInfo                                          (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
