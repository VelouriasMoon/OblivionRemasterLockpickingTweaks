...
public:
	...
	uint8                                         Pad_4736[0x4];                                     // 0x0084(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4737[0x4];                                     // 0x00A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4738[0x3];                                     // 0x010D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4739[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
// Function WBP_LegacyMenu_Added_Effects_List.WBP_LegacyMenu_Added_Effects_List_C.OnItemClicked__DelegateSignature
// 0x0060 (0x0060 - 0x0000)
struct WBP_LegacyMenu_Added_Effects_List_C_OnItemClicked__DelegateSignature final
{
public:
	struct FModernEffectItemData                  ItemClicked;                                       // 0x0000(0x0060)(BlueprintVisible, BlueprintReadOnly, Parm)
};
static_assert(alignof(WBP_LegacyMenu_Added_Effects_List_C_OnItemClicked__DelegateSignature) == 0x000008, "Wrong alignment on WBP_LegacyMenu_Added_Effects_List_C_OnItemClicked__DelegateSignature");
static_assert(sizeof(WBP_LegacyMenu_Added_Effects_List_C_OnItemClicked__DelegateSignature) == 0x000060, "Wrong size on WBP_LegacyMenu_Added_Effects_List_C_OnItemClicked__DelegateSignature");
static_assert(offsetof(WBP_LegacyMenu_Added_Effects_List_C_OnItemClicked__DelegateSignature, ItemClicked) == 0x000000, "Member 'WBP_LegacyMenu_Added_Effects_List_C_OnItemClicked__DelegateSignature::ItemClicked' has a wrong offset!");
...
// Function WBP_LegacyMenu_Added_Effects_List.WBP_LegacyMenu_Added_Effects_List_C.OnListUpdated__DelegateSignature
// 0x0004 (0x0004 - 0x0000)
struct WBP_LegacyMenu_Added_Effects_List_C_OnListUpdated__DelegateSignature final
{
public:
	int32                                         NumOfEntries;                                      // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_LegacyMenu_Added_Effects_List_C_OnListUpdated__DelegateSignature) == 0x000004, "Wrong alignment on WBP_LegacyMenu_Added_Effects_List_C_OnListUpdated__DelegateSignature");
static_assert(sizeof(WBP_LegacyMenu_Added_Effects_List_C_OnListUpdated__DelegateSignature) == 0x000004, "Wrong size on WBP_LegacyMenu_Added_Effects_List_C_OnListUpdated__DelegateSignature");
static_assert(offsetof(WBP_LegacyMenu_Added_Effects_List_C_OnListUpdated__DelegateSignature, NumOfEntries) == 0x000000, "Member 'WBP_LegacyMenu_Added_Effects_List_C_OnListUpdated__DelegateSignature::NumOfEntries' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_473A[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
