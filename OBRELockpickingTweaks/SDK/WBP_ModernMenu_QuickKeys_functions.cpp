...
// Parameters:
// int32                                   NewId                                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// Function WBP_ModernMenu_QuickKeys.WBP_ModernMenu_QuickKeys_C.OnCloseAnimationEnd__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)

void UWBP_ModernMenu_QuickKeys_C::OnCloseAnimationEnd__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_ModernMenu_QuickKeys_C", "OnCloseAnimationEnd__DelegateSignature");
...
// Parameters:
// TArray<class UTexture2D*>               IconsArray                                             (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
void UWBP_ModernMenu_QuickKeys_C::SetQuickKeyByIndex(int32 Param_Index, class UTexture2D* Texture)
{
	static class UFunction* Func = nullptr;
...
void UWBP_ModernMenu_QuickKeys_C::SetVisibilityByIndex(int32 Param_Index, bool bVisibility)
{
	static class UFunction* Func = nullptr;
