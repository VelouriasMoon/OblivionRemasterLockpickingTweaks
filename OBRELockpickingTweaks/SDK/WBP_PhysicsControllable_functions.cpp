...
// Parameters:
// struct FVPhysicsControllableDebugData   ControllableData                                       (BlueprintVisible, BlueprintReadOnly, Parm)
...
// Parameters:
// struct FVPhysicsControllableDebugData   ControllableDebugData                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
// class FName                             Param_Class                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UWBP_PhysicsControllable_C::UpdateDisplayIdentityData(class FName Label, class FName Param_Class, class FName ReferenceID, class FName InstanceId)
{
	static class UFunction* Func = nullptr;
...
// (Event, Protected, HasOutParams, BlueprintEvent)
// Parameters:
// TArray<class UVControllableEntry*>      ControllableEntries                                    (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
