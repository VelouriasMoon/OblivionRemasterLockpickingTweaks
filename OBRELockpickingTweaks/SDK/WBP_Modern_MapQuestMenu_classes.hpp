...
public:
	...
	FMulticastInlineDelegateProperty_             CreateHintKey;                                     // 0x05C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void CreateHintKey__DelegateSignature(TArray<struct FFFloatingHintXbox>& HintKeys);
	...
	void IsLocalMap(bool* Param_IsLocalMap);
	void OnFocus();
	...
	void IsMap(bool* Param_IsMap) const;
