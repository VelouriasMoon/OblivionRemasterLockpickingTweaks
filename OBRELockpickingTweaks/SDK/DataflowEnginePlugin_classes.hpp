...
{
public:
	uint8                                         Pad_31E9[0x148];                                   // 0x0578(0x0148)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UDataflowComponent) == 0x0006C0, "Wrong size on UDataflowComponent");
