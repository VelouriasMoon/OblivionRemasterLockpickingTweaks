...
public:
	...
	uint8                                         Pad_2688[0x4];                                     // 0x006C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2689[0x8];                                     // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             LoadingScreenVisibilityChanged;                    // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPrivate)
	uint8                                         Pad_268A[0x30];                                    // 0x0048(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	class UUserWidget*                            ActiveLoadingScreenUserWidgetInstance;             // 0x0078(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_268B[0x30];                                    // 0x0080(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void OnLoadingScreenVisibilityChangedDelegate__DelegateSignature(bool InNewVisibility);

	class FString GetDebugReasonForShowingOrHidingLoadingScreen() const;
	class UUserWidget* GetLoadingScreenWidget() const;
...
static_assert(offsetof(ULoadingScreenManager, LoadingScreenVisibilityChanged) == 0x000038, "Member 'ULoadingScreenManager::LoadingScreenVisibilityChanged' has a wrong offset!");
static_assert(offsetof(ULoadingScreenManager, ActiveLoadingScreenUserWidgetInstance) == 0x000078, "Member 'ULoadingScreenManager::ActiveLoadingScreenUserWidgetInstance' has a wrong offset!");
...
{
public:
	uint8                                         Pad_268C[0x18];                                    // 0x0028(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
