...
static_assert(offsetof(TABP_Stagger_C_AnimGraph, Param_AnimGraph) == 0x000000, "Member 'TABP_Stagger_C_AnimGraph::Param_AnimGraph' has a wrong offset!");
...
static_assert(offsetof(TABP_Stagger_C_StaggerLayer, Param_StaggerLayer) == 0x000010, "Member 'TABP_Stagger_C_StaggerLayer::Param_StaggerLayer' has a wrong offset!");
