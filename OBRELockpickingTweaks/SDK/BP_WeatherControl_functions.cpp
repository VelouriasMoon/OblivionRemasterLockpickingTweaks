...
void ABP_WeatherControl_C::Update_Weather__DelegateSignature(ENiagara_WeatherState Weather, double Value)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_WeatherControl_C", "Update Weather__DelegateSignature");

	Params::BP_WeatherControl_C_Update_Weather__DelegateSignature Parms{};
