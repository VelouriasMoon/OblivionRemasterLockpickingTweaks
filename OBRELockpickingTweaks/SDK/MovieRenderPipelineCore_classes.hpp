...
{
public:
	uint8                                         Pad_1D8D[0x18];                                    // 0x0028(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FGuid                                  Guid;                                              // 0x0080(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieGraphNode) == 0x000090, "Wrong size on UMovieGraphNode");
...
static_assert(offsetof(UMovieGraphNode, Guid) == 0x000080, "Member 'UMovieGraphNode::Guid' has a wrong offset!");
...
public:
	...
	class UMoviePipelineCollection* GetCollectionByName(const class FString& Param_Name) const;
...
static_assert(sizeof(UMoviePipelineRenderLayer) == 0x000048, "Wrong size on UMoviePipelineRenderLayer");
static_assert(offsetof(UMoviePipelineRenderLayer, RenderLayerName) == 0x000028, "Member 'UMoviePipelineRenderLayer::RenderLayerName' has a wrong offset!");
static_assert(offsetof(UMoviePipelineRenderLayer, Modifiers) == 0x000038, "Member 'UMoviePipelineRenderLayer::Modifiers' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphSettingNode) == 0x000090, "Wrong size on UMovieGraphSettingNode");
...
static_assert(sizeof(UMoviePipelineCollection) == 0x000048, "Wrong size on UMoviePipelineCollection");
static_assert(offsetof(UMoviePipelineCollection, CollectionName) == 0x000028, "Member 'UMoviePipelineCollection::CollectionName' has a wrong offset!");
static_assert(offsetof(UMoviePipelineCollection, Queries) == 0x000038, "Member 'UMoviePipelineCollection::Queries' has a wrong offset!");
...
{
public:
	uint8                                         bOverride_BurnInClass : 1;                         // 0x0090(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bCompositeOntoFinalImage : 1;            // 0x0090(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1D8F[0x7];                                     // 0x0091(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSoftClassPath                         BurnInClass;                                       // 0x0098(0x0020)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCompositeOntoFinalImage;                          // 0x00B8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D90[0x67];                                    // 0x00B9(0x0067)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class UClass*, class UMovieGraphBurnInWidget*> BurnInWidgetInstances;                             // 0x0120(0x0050)(ExportObject, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1D91[0x10];                                    // 0x0170(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMovieGraphBurnInNode, BurnInClass) == 0x000098, "Member 'UMovieGraphBurnInNode::BurnInClass' has a wrong offset!");
static_assert(offsetof(UMovieGraphBurnInNode, bCompositeOntoFinalImage) == 0x0000B8, "Member 'UMovieGraphBurnInNode::bCompositeOntoFinalImage' has a wrong offset!");
static_assert(offsetof(UMovieGraphBurnInNode, BurnInWidgetInstances) == 0x000120, "Member 'UMovieGraphBurnInNode::BurnInWidgetInstances' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphBurnInWidget) == 0x0002C0, "Wrong size on UMovieGraphBurnInWidget");
...
static_assert(sizeof(UMovieRenderDebugWidget) == 0x0002C0, "Wrong size on UMovieRenderDebugWidget");
...
{
public:
	uint8                                         bOverride_CollectionName : 1;                      // 0x0090(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_QueryClass : 1;                          // 0x0090(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1D92[0x7];                                     // 0x0091(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 CollectionName;                                    // 0x0098(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMoviePipelineCollectionQuery*          QueryClass;                                        // 0x00A8(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphCollectionNode) == 0x0000B0, "Wrong size on UMovieGraphCollectionNode");
static_assert(offsetof(UMovieGraphCollectionNode, CollectionName) == 0x000098, "Member 'UMovieGraphCollectionNode::CollectionName' has a wrong offset!");
static_assert(offsetof(UMovieGraphCollectionNode, QueryClass) == 0x0000A8, "Member 'UMovieGraphCollectionNode::QueryClass' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphValueContainer) == 0x000038, "Wrong size on UMovieGraphValueContainer");
static_assert(offsetof(UMovieGraphValueContainer, Value) == 0x000028, "Member 'UMovieGraphValueContainer::Value' has a wrong offset!");
...
public:
	...
	class FString                                 Name_MovieGraphMember;                             // 0x0048(0x0010)(ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGuid                                  Guid;                                              // 0x0058(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsEditable;                                       // 0x0068(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1DAA[0x7];                                     // 0x0069(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieGraphMember) == 0x000070, "Wrong size on UMovieGraphMember");
static_assert(offsetof(UMovieGraphMember, Description) == 0x000038, "Member 'UMovieGraphMember::Description' has a wrong offset!");
static_assert(offsetof(UMovieGraphMember, Name_MovieGraphMember) == 0x000048, "Member 'UMovieGraphMember::Name_MovieGraphMember' has a wrong offset!");
static_assert(offsetof(UMovieGraphMember, Guid) == 0x000058, "Member 'UMovieGraphMember::Guid' has a wrong offset!");
static_assert(offsetof(UMovieGraphMember, bIsEditable) == 0x000068, "Member 'UMovieGraphMember::bIsEditable' has a wrong offset!");
...
{
public:
	bool                                          bIsGlobal;                                         // 0x0070(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1DAB[0x7];                                     // 0x0071(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMovieGraphVariable, bIsGlobal) == 0x000070, "Member 'UMovieGraphVariable::bIsGlobal' has a wrong offset!");
...
{
public:
	bool                                          bIsBranch;                                         // 0x0070(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1DBB[0x7];                                     // 0x0071(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieGraphInterfaceBase) == 0x000078, "Wrong size on UMovieGraphInterfaceBase");
static_assert(offsetof(UMovieGraphInterfaceBase, bIsBranch) == 0x000070, "Member 'UMovieGraphInterfaceBase::bIsBranch' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphOutput) == 0x000078, "Wrong size on UMovieGraphOutput");
...
public:
	...
	uint8                                         Pad_1DBC[0x17];                                    // 0x0031(0x0017)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1DBD[0x5];                                     // 0x0063(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	TArray<class UMovieGraphInput*>               Inputs;                                            // 0x0058(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<class UMovieGraphOutput*>              Outputs;                                           // 0x0068(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieGraphConfig) == 0x000078, "Wrong size on UMovieGraphConfig");
...
static_assert(offsetof(UMovieGraphConfig, Inputs) == 0x000058, "Member 'UMovieGraphConfig::Inputs' has a wrong offset!");
static_assert(offsetof(UMovieGraphConfig, Outputs) == 0x000068, "Member 'UMovieGraphConfig::Outputs' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1DBF[0x178];                                   // 0x0038(0x0178)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieGraphDefaultRenderer) == 0x0001B0, "Wrong size on UMovieGraphDefaultRenderer");
...
{
public:
	uint8                                         Pad_1DC0[0x10];                                    // 0x0090(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieGraphDeferredRenderPassNode) == 0x0000A0, "Wrong size on UMovieGraphDeferredRenderPassNode");
...
static_assert(sizeof(UMovieGraphFileOutputNode) == 0x000090, "Wrong size on UMovieGraphFileOutputNode");
...
{
public:
	uint8                                         bOverride_Name : 1;                                // 0x0090(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1DC1[0x7];                                     // 0x0091(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 Name_MovieGraphGetCVarValueNode;                   // 0x0098(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphGetCVarValueNode) == 0x0000A8, "Wrong size on UMovieGraphGetCVarValueNode");
static_assert(offsetof(UMovieGraphGetCVarValueNode, Name_MovieGraphGetCVarValueNode) == 0x000098, "Member 'UMovieGraphGetCVarValueNode::Name_MovieGraphGetCVarValueNode' has a wrong offset!");
...
{
public:
	uint8                                         bOverride_GameModeOverride : 1;                    // 0x0090(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_CinematicQualitySettings : 1;            // 0x0090(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_TextureStreaming : 1;                    // 0x0090(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_UseLODZero : 1;                          // 0x0090(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_DisableHLODs : 1;                        // 0x0090(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_UseHighQualityShadows : 1;               // 0x0090(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_ShadowDistanceScale : 1;                 // 0x0090(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_ShadowRadiusThreshold : 1;               // 0x0090(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_OverrideViewDistanceScale : 1;           // 0x0091(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_ViewDistanceScale : 1;                   // 0x0091(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_FlushGrassStreaming : 1;                 // 0x0091(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_FlushStreamingManagers : 1;              // 0x0091(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_VirtualTextureFeedbackFactor : 1;        // 0x0091(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_DisableGPUTimeout : 1;                   // 0x0091(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1DC2[0x6];                                     // 0x0092(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class AGameModeBase>              GameModeOverride;                                  // 0x0098(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCinematicQualitySettings;                         // 0x00A0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMoviePipelineTextureStreamingMethod          TextureStreaming;                                  // 0x00A1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseLODZero;                                       // 0x00A2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDisableHLODs;                                     // 0x00A3(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseHighQualityShadows;                            // 0x00A4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1DC3[0x3];                                     // 0x00A5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         ShadowDistanceScale;                               // 0x00A8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ShadowRadiusThreshold;                             // 0x00AC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ViewDistanceScale;                                 // 0x00B0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFlushGrassStreaming;                              // 0x00B4(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bFlushStreamingManagers;                           // 0x00B5(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1DC4[0x2];                                     // 0x00B6(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         VirtualTextureFeedbackFactor;                      // 0x00B8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1DC5[0x4];                                     // 0x00BC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieGraphGlobalGameOverridesNode) == 0x0000C0, "Wrong size on UMovieGraphGlobalGameOverridesNode");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, GameModeOverride) == 0x000098, "Member 'UMovieGraphGlobalGameOverridesNode::GameModeOverride' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, bCinematicQualitySettings) == 0x0000A0, "Member 'UMovieGraphGlobalGameOverridesNode::bCinematicQualitySettings' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, TextureStreaming) == 0x0000A1, "Member 'UMovieGraphGlobalGameOverridesNode::TextureStreaming' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, bUseLODZero) == 0x0000A2, "Member 'UMovieGraphGlobalGameOverridesNode::bUseLODZero' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, bDisableHLODs) == 0x0000A3, "Member 'UMovieGraphGlobalGameOverridesNode::bDisableHLODs' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, bUseHighQualityShadows) == 0x0000A4, "Member 'UMovieGraphGlobalGameOverridesNode::bUseHighQualityShadows' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, ShadowDistanceScale) == 0x0000A8, "Member 'UMovieGraphGlobalGameOverridesNode::ShadowDistanceScale' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, ShadowRadiusThreshold) == 0x0000AC, "Member 'UMovieGraphGlobalGameOverridesNode::ShadowRadiusThreshold' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, ViewDistanceScale) == 0x0000B0, "Member 'UMovieGraphGlobalGameOverridesNode::ViewDistanceScale' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, bFlushGrassStreaming) == 0x0000B4, "Member 'UMovieGraphGlobalGameOverridesNode::bFlushGrassStreaming' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, bFlushStreamingManagers) == 0x0000B5, "Member 'UMovieGraphGlobalGameOverridesNode::bFlushStreamingManagers' has a wrong offset!");
static_assert(offsetof(UMovieGraphGlobalGameOverridesNode, VirtualTextureFeedbackFactor) == 0x0000B8, "Member 'UMovieGraphGlobalGameOverridesNode::VirtualTextureFeedbackFactor' has a wrong offset!");
...
{
public:
	uint8                                         Pad_1DC6[0x20];                                    // 0x0090(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieGraphImageSequenceOutputNode) == 0x0000B0, "Wrong size on UMovieGraphImageSequenceOutputNode");
...
static_assert(sizeof(UMovieGraphImageSequenceOutputNode_BMP) == 0x0000B0, "Wrong size on UMovieGraphImageSequenceOutputNode_BMP");
...
static_assert(sizeof(UMovieGraphImageSequenceOutputNode_JPG) == 0x0000B0, "Wrong size on UMovieGraphImageSequenceOutputNode_JPG");
...
static_assert(sizeof(UMovieGraphImageSequenceOutputNode_PNG) == 0x0000B0, "Wrong size on UMovieGraphImageSequenceOutputNode_PNG");
...
static_assert(sizeof(UMovieGraphInputNode) == 0x000090, "Wrong size on UMovieGraphInputNode");
...
static_assert(sizeof(UMovieGraphSubgraphNode) == 0x0000B8, "Wrong size on UMovieGraphSubgraphNode");
static_assert(offsetof(UMovieGraphSubgraphNode, SubgraphAsset) == 0x000090, "Member 'UMovieGraphSubgraphNode::SubgraphAsset' has a wrong offset!");
...
{
public:
	struct FMovieGraphTimeStepData                CurrentTimeStepData;                               // 0x0028(0x0020)(Transient, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_1DC7[0xE8];                                    // 0x0048(0x00E8)(Fixing Size After Last Property [ Dumper-7 ])
	class UMovieGraphEngineTimeStep*              CustomTimeStep;                                    // 0x0130(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UEngineCustomTimeStep*                  PrevCustomTimeStep;                                // 0x0138(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieGraphLinearTimeStep) == 0x000140, "Wrong size on UMovieGraphLinearTimeStep");
static_assert(offsetof(UMovieGraphLinearTimeStep, CurrentTimeStepData) == 0x000028, "Member 'UMovieGraphLinearTimeStep::CurrentTimeStepData' has a wrong offset!");
static_assert(offsetof(UMovieGraphLinearTimeStep, CustomTimeStep) == 0x000130, "Member 'UMovieGraphLinearTimeStep::CustomTimeStep' has a wrong offset!");
static_assert(offsetof(UMovieGraphLinearTimeStep, PrevCustomTimeStep) == 0x000138, "Member 'UMovieGraphLinearTimeStep::PrevCustomTimeStep' has a wrong offset!");
...
{
public:
	uint8                                         Pad_1DC8[0x10];                                    // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         bOverride_ModifierName : 1;                        // 0x0090(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_ModifiedCollectionName : 1;              // 0x0090(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_ModifierClass : 1;                       // 0x0090(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1DC9[0x7];                                     // 0x0091(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 ModifierName;                                      // 0x0098(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ModifiedCollectionName;                            // 0x00A8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMoviePipelineCollectionModifier*       ModifierClass;                                     // 0x00B8(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphModifierNode) == 0x0000C0, "Wrong size on UMovieGraphModifierNode");
static_assert(offsetof(UMovieGraphModifierNode, ModifierName) == 0x000098, "Member 'UMovieGraphModifierNode::ModifierName' has a wrong offset!");
static_assert(offsetof(UMovieGraphModifierNode, ModifiedCollectionName) == 0x0000A8, "Member 'UMovieGraphModifierNode::ModifiedCollectionName' has a wrong offset!");
static_assert(offsetof(UMovieGraphModifierNode, ModifierClass) == 0x0000B8, "Member 'UMovieGraphModifierNode::ModifierClass' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphOutputNode) == 0x000090, "Wrong size on UMovieGraphOutputNode");
...
{
public:
	uint8                                         bOverride_OutputDirectory : 1;                     // 0x0090(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_FileNameFormat : 1;                      // 0x0090(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_OutputResolution : 1;                    // 0x0090(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_OutputFrameRate : 1;                     // 0x0090(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_bOverwriteExistingOutput : 1;            // 0x0090(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_ZeroPadFrameNumbers : 1;                 // 0x0090(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_FrameNumberOffset : 1;                   // 0x0090(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1DCA[0x7];                                     // 0x0091(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDirectoryPath                         OutputDirectory;                                   // 0x0098(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FIntPoint                              OutputResolution;                                  // 0x00B8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameRate                             OutputFrameRate;                                   // 0x00C0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOverwriteExistingOutput;                          // 0x00C8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1DCB[0x3];                                     // 0x00C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         ZeroPadFrameNumbers;                               // 0x00CC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         FrameNumberOffset;                                 // 0x00D0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1DCC[0x4];                                     // 0x00D4(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieGraphOutputSettingNode) == 0x0000D8, "Wrong size on UMovieGraphOutputSettingNode");
static_assert(offsetof(UMovieGraphOutputSettingNode, OutputDirectory) == 0x000098, "Member 'UMovieGraphOutputSettingNode::OutputDirectory' has a wrong offset!");
static_assert(offsetof(UMovieGraphOutputSettingNode, FileNameFormat) == 0x0000A8, "Member 'UMovieGraphOutputSettingNode::FileNameFormat' has a wrong offset!");
static_assert(offsetof(UMovieGraphOutputSettingNode, OutputResolution) == 0x0000B8, "Member 'UMovieGraphOutputSettingNode::OutputResolution' has a wrong offset!");
static_assert(offsetof(UMovieGraphOutputSettingNode, OutputFrameRate) == 0x0000C0, "Member 'UMovieGraphOutputSettingNode::OutputFrameRate' has a wrong offset!");
static_assert(offsetof(UMovieGraphOutputSettingNode, bOverwriteExistingOutput) == 0x0000C8, "Member 'UMovieGraphOutputSettingNode::bOverwriteExistingOutput' has a wrong offset!");
static_assert(offsetof(UMovieGraphOutputSettingNode, ZeroPadFrameNumbers) == 0x0000CC, "Member 'UMovieGraphOutputSettingNode::ZeroPadFrameNumbers' has a wrong offset!");
static_assert(offsetof(UMovieGraphOutputSettingNode, FrameNumberOffset) == 0x0000D0, "Member 'UMovieGraphOutputSettingNode::FrameNumberOffset' has a wrong offset!");
...
public:
	...
	struct FMovieGraphPinProperties               Properties;                                        // 0x0030(0x000C)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1DCD[0x4];                                     // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UMovieGraphEdge*>                Edges;                                             // 0x0040(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, TextExportTransient, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieGraphPin) == 0x000050, "Wrong size on UMovieGraphPin");
...
static_assert(offsetof(UMovieGraphPin, Edges) == 0x000040, "Member 'UMovieGraphPin::Edges' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1DCE[0x10];                                    // 0x0030(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieGraphSequenceDataSource) == 0x000040, "Wrong size on UMovieGraphSequenceDataSource");
...
{
public:
	uint8                                         Pad_1DCF[0x30];                                    // 0x0028(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMoviePipelineBase) == 0x000058, "Wrong size on UMoviePipelineBase");
...
public:
	...
	uint8                                         Pad_1DD0[0x58];                                    // 0x00D8(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieGraphPipeline) == 0x000130, "Wrong size on UMovieGraphPipeline");
static_assert(offsetof(UMovieGraphPipeline, GraphTimeStepInstance) == 0x000058, "Member 'UMovieGraphPipeline::GraphTimeStepInstance' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, GraphRendererInstance) == 0x000060, "Member 'UMovieGraphPipeline::GraphRendererInstance' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, GraphDataSourceInstance) == 0x000068, "Member 'UMovieGraphPipeline::GraphDataSourceInstance' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, CurrentJob) == 0x000070, "Member 'UMovieGraphPipeline::CurrentJob' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, ActiveShotList) == 0x000078, "Member 'UMovieGraphPipeline::ActiveShotList' has a wrong offset!");
static_assert(offsetof(UMovieGraphPipeline, OutputNodesDataSentTo) == 0x000088, "Member 'UMovieGraphPipeline::OutputNodesDataSentTo' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphPathTracedRendererNode) == 0x000090, "Wrong size on UMovieGraphPathTracedRendererNode");
...
static_assert(sizeof(UMovieGraphAntiAliasingNode) == 0x000090, "Wrong size on UMovieGraphAntiAliasingNode");
...
public:
	...
	uint8                                         Pad_1DD1[0x7];                                     // 0x0091(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieGraphRenderLayerNode) == 0x0000A8, "Wrong size on UMovieGraphRenderLayerNode");
static_assert(offsetof(UMovieGraphRenderLayerNode, LayerName) == 0x000098, "Member 'UMovieGraphRenderLayerNode::LayerName' has a wrong offset!");
...
static_assert(sizeof(UMovieGraphSelectNode) == 0x0000C0, "Wrong size on UMovieGraphSelectNode");
static_assert(offsetof(UMovieGraphSelectNode, SelectOptions) == 0x000090, "Member 'UMovieGraphSelectNode::SelectOptions' has a wrong offset!");
...
static_assert(offsetof(UMovieGraphSelectNode, Description) == 0x0000B0, "Member 'UMovieGraphSelectNode::Description' has a wrong offset!");
...
public:
	uint8                                         bOverride_Name : 1;                                // 0x0090(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverride_Value : 1;                               // 0x0090(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1DD2[0x7];                                     // 0x0091(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 Name_MovieGraphSetCVarValueNode;                   // 0x0098(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Value;                                             // 0x00A8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieGraphSetCVarValueNode, Name_MovieGraphSetCVarValueNode) == 0x000098, "Member 'UMovieGraphSetCVarValueNode::Name_MovieGraphSetCVarValueNode' has a wrong offset!");
static_assert(offsetof(UMovieGraphSetCVarValueNode, Value) == 0x0000A8, "Member 'UMovieGraphSetCVarValueNode::Value' has a wrong offset!");
...
{
public:
	class UMovieGraphVariable*                    GraphVariable;                                     // 0x0090(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FMovieGraphPinProperties               OutputPin;                                         // 0x0098(0x000C)(Transient, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1DD3[0x4];                                     // 0x00A4(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieGraphVariableNode) == 0x0000A8, "Wrong size on UMovieGraphVariableNode");
static_assert(offsetof(UMovieGraphVariableNode, GraphVariable) == 0x000090, "Member 'UMovieGraphVariableNode::GraphVariable' has a wrong offset!");
static_assert(offsetof(UMovieGraphVariableNode, OutputPin) == 0x000098, "Member 'UMovieGraphVariableNode::OutputPin' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1DF3[0x3];                                     // 0x0049(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1DF4[0x7];                                     // 0x0051(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1DF5[0x3];                                     // 0x0055(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1DF6[0xB];                                     // 0x005D(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1DF7[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1DF8[0x4];                                     // 0x0064(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1DF9[0x7];                                     // 0x0039(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMoviePipelineCollectionModifier, Collections) == 0x000028, "Member 'UMoviePipelineCollectionModifier::Collections' has a wrong offset!");
static_assert(offsetof(UMoviePipelineCollectionModifier, bUseInvertedActors) == 0x000038, "Member 'UMoviePipelineCollectionModifier::bUseInvertedActors' has a wrong offset!");
...
{
public:
	uint8                                         Pad_1DFA[0x50];                                    // 0x0040(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMoviePipelineMaterialModifier) == 0x0000B8, "Wrong size on UMoviePipelineMaterialModifier");
static_assert(offsetof(UMoviePipelineMaterialModifier, MaterialToApply) == 0x000090, "Member 'UMoviePipelineMaterialModifier::MaterialToApply' has a wrong offset!");
...
{
public:
	TMap<TSoftObjectPtr<class AActor>, bool>      ModifiedActors;                                    // 0x0040(0x0050)(Transient, NativeAccessSpecifierPrivate)
	bool                                          bIsHidden;                                         // 0x0090(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1DFB[0x7];                                     // 0x0091(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMoviePipelineVisibilityModifier) == 0x000098, "Wrong size on UMoviePipelineVisibilityModifier");
static_assert(offsetof(UMoviePipelineVisibilityModifier, ModifiedActors) == 0x000040, "Member 'UMoviePipelineVisibilityModifier::ModifiedActors' has a wrong offset!");
static_assert(offsetof(UMoviePipelineVisibilityModifier, bIsHidden) == 0x000090, "Member 'UMoviePipelineVisibilityModifier::bIsHidden' has a wrong offset!");
...
static_assert(sizeof(UMoviePipelineCollectionQuery) == 0x000028, "Wrong size on UMoviePipelineCollectionQuery");
...
public:
	...
	uint8                                         Pad_1DFC[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMoviePipelineCollectionCommonQuery) == 0x000060, "Wrong size on UMoviePipelineCollectionCommonQuery");
static_assert(offsetof(UMoviePipelineCollectionCommonQuery, ComponentTypes) == 0x000028, "Member 'UMoviePipelineCollectionCommonQuery::ComponentTypes' has a wrong offset!");
static_assert(offsetof(UMoviePipelineCollectionCommonQuery, QueryMode) == 0x000038, "Member 'UMoviePipelineCollectionCommonQuery::QueryMode' has a wrong offset!");
static_assert(offsetof(UMoviePipelineCollectionCommonQuery, ActorNames) == 0x000040, "Member 'UMoviePipelineCollectionCommonQuery::ActorNames' has a wrong offset!");
static_assert(offsetof(UMoviePipelineCollectionCommonQuery, Tags) == 0x000050, "Member 'UMoviePipelineCollectionCommonQuery::Tags' has a wrong offset!");
...
static_assert(sizeof(UMoviePipelineRenderLayerSubsystem) == 0x000078, "Wrong size on UMoviePipelineRenderLayerSubsystem");
static_assert(offsetof(UMoviePipelineRenderLayerSubsystem, RenderLayers) == 0x000030, "Member 'UMoviePipelineRenderLayerSubsystem::RenderLayers' has a wrong offset!");
static_assert(offsetof(UMoviePipelineRenderLayerSubsystem, ActiveRenderLayer) == 0x000040, "Member 'UMoviePipelineRenderLayerSubsystem::ActiveRenderLayer' has a wrong offset!");
static_assert(offsetof(UMoviePipelineRenderLayerSubsystem, ActiveCollection) == 0x000048, "Member 'UMoviePipelineRenderLayerSubsystem::ActiveCollection' has a wrong offset!");
static_assert(offsetof(UMoviePipelineRenderLayerSubsystem, ActiveModifier) == 0x000050, "Member 'UMoviePipelineRenderLayerSubsystem::ActiveModifier' has a wrong offset!");
static_assert(offsetof(UMoviePipelineRenderLayerSubsystem, VisualizationRenderLayer) == 0x000058, "Member 'UMoviePipelineRenderLayerSubsystem::VisualizationRenderLayer' has a wrong offset!");
static_assert(offsetof(UMoviePipelineRenderLayerSubsystem, VisualizationEmptyCollection) == 0x000060, "Member 'UMoviePipelineRenderLayerSubsystem::VisualizationEmptyCollection' has a wrong offset!");
static_assert(offsetof(UMoviePipelineRenderLayerSubsystem, VisualizationModifier_HideWorld) == 0x000068, "Member 'UMoviePipelineRenderLayerSubsystem::VisualizationModifier_HideWorld' has a wrong offset!");
static_assert(offsetof(UMoviePipelineRenderLayerSubsystem, VisualizationModifier_VisibleCollections) == 0x000070, "Member 'UMoviePipelineRenderLayerSubsystem::VisualizationModifier_VisibleCollections' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnMoviePipelineFinishedDelegate;                   // 0x0058(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMoviePipelineWorkFinishedDelegate;               // 0x0068(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnMoviePipelineShotWorkFinishedDelegate;           // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_1DFF[0x10];                                    // 0x0090(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E00[0x258];                                   // 0x00C8(0x0258)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E01[0x8];                                     // 0x0328(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E02[0xE0];                                    // 0x0338(0x00E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMoviePipeline) == 0x000418, "Wrong size on UMoviePipeline");
static_assert(offsetof(UMoviePipeline, OnMoviePipelineFinishedDelegate) == 0x000058, "Member 'UMoviePipeline::OnMoviePipelineFinishedDelegate' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, OnMoviePipelineWorkFinishedDelegate) == 0x000068, "Member 'UMoviePipeline::OnMoviePipelineWorkFinishedDelegate' has a wrong offset!");
static_assert(offsetof(UMoviePipeline, OnMoviePipelineShotWorkFinishedDelegate) == 0x000078, "Member 'UMoviePipeline::OnMoviePipelineShotWorkFinishedDelegate' has a wrong offset!");
...
static_assert(offsetof(UMoviePipeline, CurrentJob) == 0x000330, "Member 'UMoviePipeline::CurrentJob' has a wrong offset!");
...
{
public:
	uint8                                         Pad_1E03[0x10];                                    // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E04[0x2];                                     // 0x0052(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E05[0x3];                                     // 0x0059(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E06[0x7];                                     // 0x0061(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E07[0x7];                                     // 0x00E9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E08[0x7];                                     // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E09[0x15];                                    // 0x0073(0x0015)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E0A[0x8];                                     // 0x0070(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E0E[0x2];                                     // 0x004A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E0F[0x7];                                     // 0x0051(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E10[0x18];                                    // 0x0038(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E11[0x20];                                    // 0x0060(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E12[0x10];                                    // 0x00A8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E13[0x48];                                    // 0x00D0(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1E18[0x8];                                     // 0x0048(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E19[0x1F];                                    // 0x0061(0x001F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E1A[0x3];                                     // 0x0055(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E1B[0x3];                                     // 0x0061(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E1C[0x1];                                     // 0x006B(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E1D[0xC0];                                    // 0x0070(0x00C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E1E[0x18];                                    // 0x0128(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E1F[0x4F];                                    // 0x0141(0x004F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E20[0x3];                                     // 0x0071(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E21[0x4];                                     // 0x007C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E22[0x3];                                     // 0x0081(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E23[0x3];                                     // 0x008D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E24[0x3];                                     // 0x009D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E25[0x7];                                     // 0x00A9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E27[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1E28[0xB0];                                    // 0x0068(0x00B0)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Progress;                                          // 0x0118(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1E29[0x4];                                     // 0x011C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 StatusMessage;                                     // 0x0120(0x0010)(ZeroConstructor, Transient, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMoviePipelineShotConfig*               ShotOverrideConfig;                                // 0x0130(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSoftObjectPtr<class UMoviePipelineShotConfig> ShotOverridePresetOrigin;                          // 0x0138(0x0028)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMovieGraphConfig*                      GraphConfig;                                       // 0x0160(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSoftObjectPtr<class UMovieGraphConfig>       GraphPreset;                                       // 0x0168(0x0028)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoviePipelineExecutorShot) == 0x000190, "Wrong size on UMoviePipelineExecutorShot");
...
static_assert(offsetof(UMoviePipelineExecutorShot, VariableAssignments) == 0x000060, "Member 'UMoviePipelineExecutorShot::VariableAssignments' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorShot, Progress) == 0x000118, "Member 'UMoviePipelineExecutorShot::Progress' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorShot, StatusMessage) == 0x000120, "Member 'UMoviePipelineExecutorShot::StatusMessage' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorShot, ShotOverrideConfig) == 0x000130, "Member 'UMoviePipelineExecutorShot::ShotOverrideConfig' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorShot, ShotOverridePresetOrigin) == 0x000138, "Member 'UMoviePipelineExecutorShot::ShotOverridePresetOrigin' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorShot, GraphConfig) == 0x000160, "Member 'UMoviePipelineExecutorShot::GraphConfig' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorShot, GraphPreset) == 0x000168, "Member 'UMoviePipelineExecutorShot::GraphPreset' has a wrong offset!");
...
public:
	...
	class UMovieJobVariableAssignmentContainer*   VariableAssignments;                               // 0x00B8(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 StatusMessage;                                     // 0x00C0(0x0010)(ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         StatusProgress;                                    // 0x00D0(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIsConsumed;                                       // 0x00D4(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1E2B[0x3];                                     // 0x00D5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UMoviePipelinePrimaryConfig*            Configuration;                                     // 0x00D8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSoftObjectPtr<class UMoviePipelinePrimaryConfig> PresetOrigin;                                      // 0x00E0(0x0028)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bEnabled;                                          // 0x0108(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1E2C[0x7];                                     // 0x0109(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UMovieGraphConfig*                      GraphConfig;                                       // 0x0110(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSoftObjectPtr<class UMovieGraphConfig>       GraphPreset;                                       // 0x0118(0x0028)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMoviePipelineExecutorJob) == 0x000140, "Wrong size on UMoviePipelineExecutorJob");
...
static_assert(offsetof(UMoviePipelineExecutorJob, VariableAssignments) == 0x0000B8, "Member 'UMoviePipelineExecutorJob::VariableAssignments' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorJob, StatusMessage) == 0x0000C0, "Member 'UMoviePipelineExecutorJob::StatusMessage' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorJob, StatusProgress) == 0x0000D0, "Member 'UMoviePipelineExecutorJob::StatusProgress' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorJob, bIsConsumed) == 0x0000D4, "Member 'UMoviePipelineExecutorJob::bIsConsumed' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorJob, Configuration) == 0x0000D8, "Member 'UMoviePipelineExecutorJob::Configuration' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorJob, PresetOrigin) == 0x0000E0, "Member 'UMoviePipelineExecutorJob::PresetOrigin' has a wrong offset!");
...
static_assert(offsetof(UMoviePipelineExecutorJob, GraphConfig) == 0x000110, "Member 'UMoviePipelineExecutorJob::GraphConfig' has a wrong offset!");
static_assert(offsetof(UMoviePipelineExecutorJob, GraphPreset) == 0x000118, "Member 'UMoviePipelineExecutorJob::GraphPreset' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1E2D[0x8];                                     // 0x0060(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1E2F[0x40];                                    // 0x0050(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1E31[0x48];                                    // 0x0048(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
