...
static_assert(sizeof(UMoviePipelineBurnInWidget) == 0x0002C0, "Wrong size on UMoviePipelineBurnInWidget");
...
public:
	...
	uint8                                         Pad_31B5[0x2F];                                    // 0x0069(0x002F)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_31B6[0x20];                                    // 0x00D8(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	bool AddConsoleVariable(const class FString& Param_Name, const float Value);
	bool AddOrUpdateConsoleVariable(const class FString& Param_Name, const float Value);
	bool RemoveConsoleVariable(const class FString& Param_Name, const bool bRemoveAllInstances);
	bool UpdateConsoleVariableEnableState(const class FString& Param_Name, const bool bIsEnabled);
...
public:
	...
	uint8                                         Pad_31BB[0x17];                                    // 0x0049(0x0017)(Fixing Size After Last Property [ Dumper-7 ])
