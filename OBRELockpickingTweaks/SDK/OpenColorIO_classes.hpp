...
public:
	...
	uint8                                         Pad_177B[0x7];                                     // 0x0039(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_177D[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_177E[0x7];                                     // 0x0071(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<int32, class UTexture*>                  Textures;                                          // 0x0078(0x0050)(UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_177F[0xA0];                                    // 0x00C8(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UOpenColorIOColorTransform) == 0x000168, "Wrong size on UOpenColorIOColorTransform");
static_assert(offsetof(UOpenColorIOColorTransform, bIsDisplayViewType) == 0x000028, "Member 'UOpenColorIOColorTransform::bIsDisplayViewType' has a wrong offset!");
...
static_assert(offsetof(UOpenColorIOColorTransform, Display) == 0x000050, "Member 'UOpenColorIOColorTransform::Display' has a wrong offset!");
static_assert(offsetof(UOpenColorIOColorTransform, View) == 0x000060, "Member 'UOpenColorIOColorTransform::View' has a wrong offset!");
static_assert(offsetof(UOpenColorIOColorTransform, DisplayViewDirection) == 0x000070, "Member 'UOpenColorIOColorTransform::DisplayViewDirection' has a wrong offset!");
static_assert(offsetof(UOpenColorIOColorTransform, Textures) == 0x000078, "Member 'UOpenColorIOColorTransform::Textures' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1780[0x28];                                    // 0x0068(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1781[0x10];                                    // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
