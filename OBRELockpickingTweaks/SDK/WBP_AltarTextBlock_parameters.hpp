...
{
public:
	struct FSlateColor                            Param_Color;                                       // 0x0000(0x0014)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
static_assert(offsetof(WBP_AltarTextBlock_C_SetColor, Param_Color) == 0x000000, "Member 'WBP_AltarTextBlock_C_SetColor::Param_Color' has a wrong offset!");
