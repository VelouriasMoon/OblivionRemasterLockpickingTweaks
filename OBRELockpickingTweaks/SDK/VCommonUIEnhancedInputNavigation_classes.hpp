...
class IVEnhancedInputNavigable final : public IInterface
{
public:
...
static_assert(alignof(IVEnhancedInputNavigable) == 0x000008, "Wrong alignment on IVEnhancedInputNavigable");
static_assert(sizeof(IVEnhancedInputNavigable) == 0x000028, "Wrong size on IVEnhancedInputNavigable");
...
public:
	...
	uint8                                         Pad_26EB[0x4];                                     // 0x0054(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_26EC[0x8];                                     // 0x0410(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_26ED[0x45];                                    // 0x046B(0x0045)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_26EE[0x8];                                     // 0x1580(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnHoldCanceledEvent;                               // 0x1588(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, BlueprintCallable, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_26EF[0x10];                                    // 0x15F0(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_26F0[0x5];                                     // 0x160B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_26F1[0x26];                                    // 0x162A(0x0026)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_26F2[0x6];                                     // 0x04C2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_26F3[0x7];                                     // 0x04D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void ClearChildren();
	class UPanelSlot* InsertChild(class UWidget* ChildToAdd, int32 Param_Index);
	...
	class UWidget* GetItemAtIndex(int32 Param_Index) const;
...
{
public:
	uint8                                         Pad_26F8[0x8];                                     // 0x02E8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_26F9[0x16];                                    // 0x0342(0x0016)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_26FA[0x20];                                    // 0x0368(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	FMulticastInlineDelegateProperty_             OnValueCommittedHandle;                            // 0x04C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnValueChangedHandle;                              // 0x04D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_26FB[0x8];                                     // 0x04E8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void OnValueCommittedDelegate__DelegateSignature(const class FText& CommittedValue);
...
public:
	...
	uint8                                         Pad_26FD[0x7];                                     // 0x04C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_26FE[0x7];                                     // 0x04D1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	FMulticastInlineDelegateProperty_             OnIsSelectingKeyChangedHandle;                     // 0x04C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnKeySelectedHandle;                               // 0x04D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnListenStateChangedHandle;                        // 0x04E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_26FF[0x3F];                                    // 0x0511(0x003F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	FMulticastInlineDelegateProperty_             OnItemHovered;                                     // 0x04C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnItemClicked;                                     // 0x04D0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnItemClickReleased;                               // 0x04E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_2700[0x2];                                     // 0x04FE(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2701[0x20];                                    // 0x0508(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2702[0x10];                                    // 0x0530(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void NavigateToNextElement();
	void NavigateToPrevElement();
	void OnItemClicked__DelegateSignature(class UObject* SelectedItem);
	void OnItemClickReleased__DelegateSignature(class UObject* SelectedItem);
	void OnItemHovered__DelegateSignature(class UObject* Param_HoveredItem);
...
public:
	...
	uint8                                         Pad_2704[0x3];                                     // 0x04CD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2705[0x10];                                    // 0x04D8(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	FMulticastInlineDelegateProperty_             OnValueChanged;                                    // 0x04C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_2706[0x7];                                     // 0x04D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2707[0x14];                                    // 0x04FC(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void OnValueChangedDelegate__DelegateSignature(float CommitedValue);
...
public:
	...
	uint8                                         Pad_2708[0x3];                                     // 0x04ED(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2709[0x1F];                                    // 0x04F9(0x001F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_270A[0x10];                                    // 0x0520(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void NavigateToIndex1D(int32 Param_Index);
	void OnItemClicked__DelegateSignature(class UObject* SelectedItem);
	void OnItemHovered__DelegateSignature(class UObject* Param_HoveredItem);
...
public:
	bool                                          bDoNavigationLoop;                                 // 0x04C0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_270C[0x7];                                     // 0x04C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_270D[0x8];                                     // 0x04D0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	FMulticastInlineDelegateProperty_             OnSwitcherChangedDelegate;                         // 0x04C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_270E[0x8];                                     // 0x04D8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	FMulticastInlineDelegateProperty_             OnNewLayerFocusedDelegate;                         // 0x0030(0x0010)(BlueprintVisible, ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnNewTopMostWidgetFocusedDelegate;                 // 0x0040(0x0010)(BlueprintVisible, ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_270F[0x10];                                    // 0x0050(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
