...
public:
	...
	FMulticastInlineDelegateProperty_             OnMouseUsedDispatcherSmooth;                       // 0x05E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	uint8                                         Pad_4772[0x5];                                     // 0x05FB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnClickLocalMapButton;                             // 0x0600(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void OnClickLocalMapButton__DelegateSignature();
	void OnMouseUsedDispatcherSmooth__DelegateSignature();
	void PostInit(bool IsWorld);
	void SetHandlePositionWhenChangingMap(bool Param_IsWorldMap);
