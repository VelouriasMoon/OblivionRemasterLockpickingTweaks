...
void UWBP_ListView_Help_C::OnItemSelected__DelegateSignature(class UObject* Item)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_ListView_Help_C", "OnItemSelected__DelegateSignature");

	Params::WBP_ListView_Help_C_OnItemSelected__DelegateSignature Parms{};
...
// Parameters:
// TArray<class UHelpMenuListEntryData*>   InListData                                             (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
