...
{
public:
	uint8                                         Pad_260D[0x20];                                    // 0x0FD0(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bEnable : 1;                                       // 0x0FF0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bAutoRegisterWithBudgetAllocator : 1;              // 0x0FF0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bAutoCalculateSignificance : 1;                    // 0x0FF0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bShouldUseActorRenderedFlag : 1;                   // 0x0FF0(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         Pad_260E[0x7];                                     // 0x0FF1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USkeletalMeshComponentBudgeted) == 0x001000, "Wrong size on USkeletalMeshComponentBudgeted");
