...
static_assert(offsetof(ABP_HumanoidHead_C_AnimGraph, Param_AnimGraph) == 0x000000, "Member 'ABP_HumanoidHead_C_AnimGraph::Param_AnimGraph' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_3C1E[0x7];                                     // 0x0019(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	class USkeletalMeshComponent*                 Param_BodyMesh;                                    // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ABP_HumanoidHead_C_UpdateBodyMesh, Param_BodyMesh) == 0x000000, "Member 'ABP_HumanoidHead_C_UpdateBodyMesh::Param_BodyMesh' has a wrong offset!");
