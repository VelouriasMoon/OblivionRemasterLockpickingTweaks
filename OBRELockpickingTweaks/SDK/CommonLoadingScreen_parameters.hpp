...
// DelegateFunction CommonLoadingScreen.LoadingScreenManager.OnLoadingScreenVisibilityChangedDelegate__DelegateSignature
// 0x0001 (0x0001 - 0x0000)
struct LoadingScreenManager_OnLoadingScreenVisibilityChangedDelegate__DelegateSignature final
{
public:
...
static_assert(alignof(LoadingScreenManager_OnLoadingScreenVisibilityChangedDelegate__DelegateSignature) == 0x000001, "Wrong alignment on LoadingScreenManager_OnLoadingScreenVisibilityChangedDelegate__DelegateSignature");
static_assert(sizeof(LoadingScreenManager_OnLoadingScreenVisibilityChangedDelegate__DelegateSignature) == 0x000001, "Wrong size on LoadingScreenManager_OnLoadingScreenVisibilityChangedDelegate__DelegateSignature");
static_assert(offsetof(LoadingScreenManager_OnLoadingScreenVisibilityChangedDelegate__DelegateSignature, InNewVisibility) == 0x000000, "Member 'LoadingScreenManager_OnLoadingScreenVisibilityChangedDelegate__DelegateSignature::InNewVisibility' has a wrong offset!");
...
// Function CommonLoadingScreen.LoadingScreenManager.GetLoadingScreenWidget
// 0x0008 (0x0008 - 0x0000)
struct LoadingScreenManager_GetLoadingScreenWidget final
{
public:
...
static_assert(alignof(LoadingScreenManager_GetLoadingScreenWidget) == 0x000008, "Wrong alignment on LoadingScreenManager_GetLoadingScreenWidget");
static_assert(sizeof(LoadingScreenManager_GetLoadingScreenWidget) == 0x000008, "Wrong size on LoadingScreenManager_GetLoadingScreenWidget");
static_assert(offsetof(LoadingScreenManager_GetLoadingScreenWidget, ReturnValue) == 0x000000, "Member 'LoadingScreenManager_GetLoadingScreenWidget::ReturnValue' has a wrong offset!");
