...
void ABP_Generic_BDP_LowerBody_C::OnAttachedToPhenotype(class UVCharacterPhenotypeData* PhenotypeData, class UTESRace* Param_CharacterRace, ECharacterSex Param_CharacterSex)
{
	static class UFunction* Func = nullptr;
...
void ABP_Generic_BDP_LowerBody_C::OverrideFemaleMaterials(ECharacterSex Param_CharacterSex)
{
	static class UFunction* Func = nullptr;
