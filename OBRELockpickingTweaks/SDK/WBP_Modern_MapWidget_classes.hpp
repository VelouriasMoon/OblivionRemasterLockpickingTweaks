...
public:
	...
	FMulticastInlineDelegateProperty_             IconClickedDispatcher;                             // 0x07E8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	FMulticastInlineDelegateProperty_             PlayerMarkerDispatcher;                            // 0x07F8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	uint8                                         Pad_43B7[0x7];                                     // 0x0809(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             RequestChangeMapDispatcher;                        // 0x0810(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	uint8                                         Pad_43B8[0x3];                                     // 0x0821(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	FMulticastInlineDelegateProperty_             RequestSleepWaitMenu;                              // 0x0878(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	uint8                                         Pad_43B9[0x3];                                     // 0x0889(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_43BA[0x6];                                     // 0x0892(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_43BB[0x2];                                     // 0x08CA(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void IconClickedDispatcher__DelegateSignature(const class FString& IconAddress);
	...
	void PlayerMarkerDispatcher__DelegateSignature(const struct FVector2D& Position);
	void PluginCompilation(bool NewParam);
	void RequestChangeMapDispatcher__DelegateSignature(const struct FVector2D& VirtualCursorPosition);
	void RequestSleepWaitMenu__DelegateSignature();
