...
void UWBP_OriginalMenu_InventoryDetails_Tooltip_IngredientEffects_C::OnEffectsUpdated__DelegateSignature(int32 EffectsNb)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_OriginalMenu_InventoryDetails_Tooltip_IngredientEffects_C", "OnEffectsUpdated__DelegateSignature");

	Params::WBP_OriginalMenu_InventoryDetails_Tooltip_IngredientEffects_C_OnEffectsUpdated__DelegateSignature Parms{};
