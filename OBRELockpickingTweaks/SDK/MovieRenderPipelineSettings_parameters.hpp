...
public:
	...
	uint8                                         Pad_31B7[0x3];                                     // 0x0015(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(MoviePipelineConsoleVariableSetting_AddConsoleVariable, Param_Name) == 0x000000, "Member 'MoviePipelineConsoleVariableSetting_AddConsoleVariable::Param_Name' has a wrong offset!");
...
public:
	...
	float                                         Value;                                             // 0x0010(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0014(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_31B8[0x3];                                     // 0x0015(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(MoviePipelineConsoleVariableSetting_AddOrUpdateConsoleVariable, Param_Name) == 0x000000, "Member 'MoviePipelineConsoleVariableSetting_AddOrUpdateConsoleVariable::Param_Name' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_31B9[0x6];                                     // 0x0012(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(MoviePipelineConsoleVariableSetting_RemoveConsoleVariable, Param_Name) == 0x000000, "Member 'MoviePipelineConsoleVariableSetting_RemoveConsoleVariable::Param_Name' has a wrong offset!");
...
public:
	...
	bool                                          ReturnValue;                                       // 0x0011(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_31BA[0x6];                                     // 0x0012(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(MoviePipelineConsoleVariableSetting_UpdateConsoleVariableEnableState, Param_Name) == 0x000000, "Member 'MoviePipelineConsoleVariableSetting_UpdateConsoleVariableEnableState::Param_Name' has a wrong offset!");
